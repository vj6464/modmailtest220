...
class Utility(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.set_author(
            ...
            url="https://discord.gg/d7kcqmp",
        )
        embed.set_thumbnail(url=self.bot.user.avatar_url)

        desc = "This is an open source Discord bot developed by NXS OFFICIAL "
        ...
        embed.add_field(name="Authors", value="`NEXUS ôLEGEND`, `NEXUS ôGURU`, `NEXUS ôEVIL VIRAT`")
        ...
        embed.add_field(
            ...
            value="Get the installation guide on [DISCORD](https://discord.gg/d7kcqmp) "
            "and join our [Discord server](https://discord.gg/d7kcqmp/)!",
            inline=False,
        )
        ...
        embed.add_field(
            ...
            "like you to support us on [`Patreon`](https://patreon.com/H) (perks included) "
